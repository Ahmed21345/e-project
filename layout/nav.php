         ...
         <?php if (isset($_SESSION['user']) && !empty($_SESSION['user'])) : ?>
             <div class="dropdown lawyer_drop">
                 ...
                 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                     <?php if ($_SESSION['user']['role'] == 'LAWYER') :   $lawyer_id = $_SESSION['user']['id'];?>
                         <!-- <a class="dropdown-item" href="#"><i class="fa fa-edit"></i>Edit Profile</a> -->
                         <a class="dropdown-item <?php if ($page == 'appointment') {
                                                        echo 'active';
                                                    } ?>" href="lawyer_appointments.php?lawyer_id=<?php echo $lawyer_id ?>"><i class="fa fa-check-circle"></i>Appointments</a>
                     <?php endif ?>
